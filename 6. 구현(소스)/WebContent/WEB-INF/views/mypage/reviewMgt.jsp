        ...
        <div class="container mainContents">
            ...
            <div role="tabpanel" id="tabbg">
                <ul class="nav nav-tabs" role="tablist" id="reviewTab">
                    <li role="presentation" class="active"><a href="#spot" aria-controls="home" role="tab" data-toggle="tab">명소</a></li>
                ...
                <div class="tab-content">
                    ...
                    <table id="tbl1" class="table table-hover list">
                        <thead>
                            <tr>
                                <th>번호</th>
                                <th>이름</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>${dto.score}/10</td>
                                <td>
                                    <input type="button" class="edit btn btn-primary" value="수정" onclick="location.href='/project/mypage/reviewEdit.do?seq=${dto.seq}';">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-danger" onclick="location.href='sreviewdeleteok.do?seq=${dto.seq}';">삭제</button>
