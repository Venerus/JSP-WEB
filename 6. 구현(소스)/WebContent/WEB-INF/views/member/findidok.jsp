...
<body>
	...
	<div class="main">
		...
		<div id="pageTitle"><span>아이디찾기</span></div>
        ...
        <div class="container mainContents"> 
            ...
            <div class="modal-body" style="font-size: 2em;">
                <div class="mainText">
                    회원의 아이디는<br>
                    <span style="font-size:1.3em; color:cornflowerblue; font-weight: bold; margin-top: 30px; margin-bottom: 30px;">${id}</span><br>
                    입니다.
                </div>
                <div style="margin-top: 20px;">
                    <a href="/project/member/login.do" style="font-size: .7em;">로그인하기</a>
                    <a href="/project/member/findPw.do" style="font-size: .7em;">비밀번호 찾기</a>
                </div>
            ...
            <div class="modal-body" style="font-size: 2em;">
                ...
                <div style="margin-top: 20px;">
                    <a href="/project/member/findId.do" style="font-size: .7em;">돌아가기</a>
                </div>
