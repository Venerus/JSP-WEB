...
@WebServlet("/mypage/tipedit.do")
public class TipEdit extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		TipDTO dto = dao.tipGet(seq);
		
		//3.
		req.setAttribute("dto", dto);
		req.setAttribute("tourPlanSeq", tourPlanSeq);
		
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/mypage/tipEdit.jsp");
