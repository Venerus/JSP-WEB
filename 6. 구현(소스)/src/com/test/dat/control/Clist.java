...
//			}
		...
		ArrayList<CboardDTO> list = dao.list(map);
		...
		if (n == 1) {
			...
			pagebar += String.format("<li>"
					+ "            <a href=\"/project/control/clist.do?page=%d\" aria-label=\"Previous\">"
					+ "                <span aria-hidden=\"true\">&laquo;</span>"
					+ "            </a>"
					+ "        </li>", n - 1);
		}
		...
		while (!(loop > blockSize || n > totalPage)) {
			...
			pagebar += String.format("<a href=\"/project/control/clist.do?page=%d\">%d</a></li>", n, n);
		...
		if (n > totalPage) {
			...
			pagebar += String.format("<li>"
					+ "            <a href=\"/project/control/clist.do?page=%d\" aria-label=\"Next\">"
					+ "                <span aria-hidden=\"true\">&raquo;</span>"
					+ "            </a>"
					+ "        </li>", n);
	...
	RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/control/clist.jsp");
